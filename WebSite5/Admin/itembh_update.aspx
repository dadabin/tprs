<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itembh_update.aspx.cs" Inherits="Admin_itembh_add" %>
...
<tr> <td colspan="4" align="center" class="style3"> 基本信息</td></tr>
...
<td align="right" class="style2"  width="15%">工程名称：</td><td style="color: #FF0000">
...
<td align="right" class="style2">占用方式：</td><td>
    <asp:DropDownList ID="DropDownList4" runat="server" CssClass="select" 
        Font-Size="Small" Height="24px" Width="205px">
...
<td align="right">目前工程的形象进度：</td><td colspan="3">
    <asp:TextBox ID="TextBox16" runat="server" TextMode="MultiLine" CssClass="textarea" 
                Height="70px" Width="765px"></asp:TextBox>
    </td></tr>
<tr><td align="right">管护主体：</td><td style="color: #FF0000">
    <asp:TextBox ID="TextBox17" runat="server" CssClass="text"></asp:TextBox>
    </td><td align="right">四个一批范畴：</td><td><asp:DropDownList ID="DropDownList1" runat="server" 
...
<tr><td align="center" colspan="4" >
    <asp:Button ID="Button1" runat="server" Text="保存"  ValidationGroup="add"  Font-Size="14px" ForeColor="White" BackColor="#2480F1"
        onclick="Button1_Click" CssClass="button" Height="35px" Width="97px" /></td></tr>
</table>
<br />
