<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itemjg_season_update.aspx.cs" Inherits="Admin_itemjg_season_update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%"bgcolor="#F6F7F9">
        <tr>
            <td colspan="4" class="style2" align="center">景观农业重大项目季度推进表
            <!--隐藏表单--->
            </td>
        </tr>
        <tr>
            <td width="20%" align="right">所属区县:</td>
            <td width="30%"><asp:Label ID="Label1" runat="server" Height="20px" Width="200px"></asp:Label></td>
            <td align="right" width="20%">项目名称:</td>
            <td width="30%">
                <asp:Label ID="ProjectNameText" runat="server" Height="20px" 
        ...
        <tr> <td align="right">项目建设规模:</td>
             <td colspan="3"><asp:Label ID="ContentScaleText" runat="server" Height="70px" 
                     Width="680px"></asp:Label></td>
             
        </tr>
        <tr>
            <td align="right">计划总投资:</td>
            <td  style="font-size: 13px"><asp:Label ID="PlanTotalMoneyText" runat="server" Height="20px" Width="200px"></asp:Label>（万元）</td>
            <td align="right"><%=submitTime.Year%>计划投资:</td>
            <td style="font-size: 13px"><asp:Label ID="xyYearMoney" runat="server" Height="20px" Width="200px"></asp:Label>（万元）</td>

        </tr>
        <tr>
            <td align="right"><%=submitTime.Year%>年底工程应达形象进度:</td>
            <td colspan="3" style="font-size: 13px"><asp:Label ID="EndTimeText" runat="server" Height="70px" Width="680px"></asp:Label>（可修改）</td>
        </tr>
        <tr>
            <td class="style1" align="right">至 <%=submitTime.Year%>年已累计完成投资:</td>
            <td style="font-size: 13px">
                <asp:Label ID="FinishTotalInvestmentText" runat="server" Height="19px" 
                    CssClass="text"></asp:Label>
                （万元）（可修改）</td>
                    <td align="right"> <%=submitTime.Year%>年<%=submitTime.Month%>月完成投资:</td>
                    <td style="font-size: 13px"> 
                        <asp:TextBox ID="FinishInvestmentText" runat="server" CssClass="text"   AutoPostBack="True" EnableTheming="True"
                            ontextchanged="FinishInvestmentText_TextChanged"></asp:TextBox>
                        (万元)(可修改)</td>
        
        </tr>
        <tr>
            <td align="right"><%=submitTime.Year%>年1-<%=submitTime.Month%>月完成投资：</td>
            <td> 
                <asp:Label ID="TextBox1" runat="server" CssClass="text"></asp:Label></td>
        ...
        <tr>
            <td class="style1" align="right">目前形象进度：</td>
            <td colspan="3">
                <asp:TextBox ID="ImageProgressText" runat="server" Height="76px" Width="781px"></asp:TextBox> 
                    （可修改）</td>
        </tr>
