<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itemst_view_project.aspx.cs" Inherits="Admin_view_itemst_view_project" %>
...
<table width="100%">
<tr><td colspan="4" align="center" class="style2">1.基本信息</td></tr>
<tr>
    <td align="right" width="20%">所属区县：</td><td width="25%">
    <asp:Label ID="Label1" runat="server" Text="区县" Height="20px" Width="200px"></asp:Label>&nbsp;</td>
    <td align="right"width="20%">项目名称：</td><td width="25%">
        <asp:Label ID="Label2" runat="server" Text="Label" Height="20px" Width="300px"></asp:Label>
    </td>
    </tr>
...
<tr><td align="right">总投资：</td><td style="font-size: 13px">
...
<tr><td align="right">省级资金：</td><td style="font-size: 13px">
    ...
    <td style="font-size: 13px">
        ...
        (万元)</td></tr>
<tr><td align="right">区县资金：</td><td style="font-size: 13px">
...
<tr><td align="right" >企业自筹：</td><td style="font-size: 13px">
    ...
    <td class="style9" style="font-size: 13px">
       ...
       (万元)</td></tr>
<tr><td align="right"><%=submitTime.Year%>年计划投资：</td><td colspan="3" style="font-size: 13px">
...
<tr><td align="right">开工(计划开工)时间：</td><td class="style5">
    ...
    <tr><td align="right" >四个一批范畴：</td><td class="style4"colspan="3"> 
        <asp:Label ID="Label24" runat="server" Text="" Height="20px" Width="200px"></asp:Label>
        </td></tr>

<tr><td align="right" >已取得土地指标：</td><td style="font-size: 13px">
    <asp:Label ID="Label25" runat="server" Text="" Height="20px" Width="200px"></asp:Label>
    （亩）</td><td align="right" >拟申请土地指标：</td><td style="font-size: 13px">
    <asp:Label ID="Label26" runat="server" Text="" Height="20px" Width="200px"></asp:Label>
    （亩）</td></tr>
    <tr> <td align="right">是否政府投资项目：</td><td>
        <asp:Label ID="Label27" runat="server" Text="" Height="20px" Width="200px"></asp:Label></td>
        <td align="right">&nbsp;&nbsp;&nbsp; <% if (submitTime.Month - 1 == 0){Response.Write(1);}else{Response.Write(submitTime.Month - 1);}%>月完成投资额：</td><td style="font-size: 13px">
                    <asp:Label ID="Label29" runat="server" Text="" Height="20px" Width="200px"></asp:Label>
                    (万元)</td>
       </tr>
    <tr> <td align="right">1-<%if (submitTime.Month - 1 == 0){Response.Write(1);}else{Response.Write(submitTime.Month - 1);}%>月完成投资额：</td><td colspan="3" style="font-size: 13px">
            <asp:Label ID="Label28" runat="server" Text="" Height="20px" Width="200px"></asp:Label>
            (万元)</td></tr>
     <tr><td align="right">需要协调解决的问题：</td><td colspan ="3"><asp:Label ID="Label30" runat="server" Text="" Height="70px" Width="680px"></asp:Label>
                            </td> </tr>
   <tr><td align="right">备注：</td><td colspan="3"> 
