<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itemst_month_update.aspx.cs" Inherits="Admin_itemst_month_update" %>
    ...
    <table width="100%"bgcolor="#F6F7F9">
        <tr>
            <td colspan="4" align="center" 
                ...
                valign="middle" class="style2">重大项目月报</td>
        </tr>
        <tr>
            ...
            <td><asp:Label ID="Label2" runat="server" Height="20px" Width="200px"></asp:Label></td>
        </tr>
        <tr>
           <td align="right">
               建设地址：</td>
        ...
        <tr>
            <td style="font-size: medium;" class="style10" align="right">目前为止项目形象进度：</td>
        ...
        <tr>
            <td align="right" ><%=reportTime.Month%>月完成投资额：</td>
                <td class="style14" style="font-size: 13px">
                    ...
                    (万元) 
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Label21" runat="server" ErrorMessage="必填项*"></asp:RequiredFieldValidator></td>
                <td align="right">1-<%=reportTime.Month%>月完成投资额：</td>
                <td style="font-size: 13px">
                    <asp:Label ID="total" runat="server" CssClass="text" Width="200px"></asp:Label> 
                    (万元)</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="4">
                <asp:Button ID="Button1" 
                    ...
                    Height="36px" Width="86px" onclick="Button1_svae" /></td>
        </tr>
