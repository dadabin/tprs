<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itemst_season_update.aspx.cs" Inherits="Admin_itemst_season_update" %>
    ...
    <table width="100%"bgcolor="#F6F7F9">
        <tr>
            <td colspan="4" align="center" 
                ...
                valign="middle" class="style2">重大项目季度报</td>
        </tr>
        <tr>
            ...
            <td width="25%"><asp:Label ID="Label2" runat="server" Height="20px" Width="200px"></asp:Label>
            </td>
        ...
        <tr>
           <td align="right">
            ...
            <td> 
                ...
                <td><asp:Label ID="Label4" runat="server" Height="20px" Width="200px"></asp:Label></td>
       ...
       <tr>
            ...
            <td colspan="3"><input id="File1" type="file"  />
                <asp:Button ID="Button3" runat="server" Text="上传" Height="32px" Width="73px" />（可修改）</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right"><%=DateTime.Now.Month %>季度完成投资额：</td>
                <td class="style14">
                    <asp:TextBox ID="Label21" runat="server" Height="20px" Width="200px"></asp:TextBox>
                    (万元)(可修改)</td>
                <td align="right">1-<%=DateTime.Now.Month %>季度完成投资额：</td>
                <td>
                    <asp:Label ID="total" runat="server" CssClass="text"></asp:Label> (万元)</td>
        </tr>
        <tr>
        ...
        <tr>
            <td  align="center" colspan="4">
                <asp:Button ID="Button1" 
                    ...
                    Height="35px" Width="84px" onclick="Button1_svae" Font-Size="14px" /></td>
        </tr>
