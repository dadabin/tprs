<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/index.master" AutoEventWireup="true" CodeFile="itembh_season_manage.aspx.cs" Inherits="Admin_itembh_season_manage" Theme="style" %>
...
<hr style="border: 1px solid #1739E6"/>
 ...
 <asp:TemplateField HeaderText="项目编号">
   ...
   <webdiyer:AspNetPager ID="AspNetPager1" PageSize="12"  PrevPageText="上一页" 
        LastPageText="尾页" FirstPageText="首页" NextPageText="下一页" runat="server" 
        Font-Size="14px" >
